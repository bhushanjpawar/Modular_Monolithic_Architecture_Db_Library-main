...
const getUserByIdentifier_1 = require("../../../apps/feature/v1/getUserByIdentifier");
...
(0, node_test_1.describe)(`Get Users By Identifier Unit Test`, () => {
    ...
    (0, node_test_1.default)(`should_return_false_when_userEntity_identifier_is_not_provided`, async () => {
        ...
        const getUserByIdentifierServiceResult = await new getUserByIdentifier_1.GetUsersByIdentifierService().handleAsync({
    ...
    (0, node_test_1.default)(`should_return_false_when_identifier_is_provided_wrong`, async () => {
        const userEntity = new tUsers_1.UserEntity();
    ...
    (0, node_test_1.default)(`should_return_true_when_userEntity_is_not_provided`, async () => {
        const userEntity = new tUsers_1.UserEntity();
