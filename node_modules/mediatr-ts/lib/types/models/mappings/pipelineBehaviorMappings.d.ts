...
import { OrderedMappings, OrderedMapping } from "./orderedMappings";
 ...
 * @exports
 */
export declare class PipelineBehaviorMappings extends OrderedMappings<PipelineBehaviorData> {
    /**
     ...
     */
    setOrder(behaviorClasses: PipelineBehaviorClass[]): void;
    /**
     ...
     */
    getAll(): OrderedMapping<PipelineBehaviorData>[];
}
export {};
