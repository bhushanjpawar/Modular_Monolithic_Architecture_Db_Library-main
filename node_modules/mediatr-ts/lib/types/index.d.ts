...
export { RequestData, RequestHandler, requestHandler, NotificationData, notificationHandler, NotificationHandler, Resolver, Mediator, PipelineBehavior, pipelineBehavior, Class };
/**
 * @deprecated Use requestHandler instead
 */
export declare const Handler: <T>(value: import("./models/requestData.js").RequestDataClass<T>) => (target: Function) => void;
