...
var instantiationResolver_1 = require("./instantiationResolver");
/**
 * The mediator class.
...
var Mediator = /** @class */ (function () {
    ...
    function Mediator(settings) {
        var resolver = (settings === null || settings === void 0 ? void 0 : settings.resolver) || new instantiationResolver_1.InstantiationResolver();
    ...
    Object.defineProperty(Mediator.prototype, "notifications", {
         ...
         */
        get: function () {
            return index_js_1.typeMappings.notifications;
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Mediator.prototype, "pipelineBehaviors", {
         ...
         */
        get: function () {
            return index_js_1.typeMappings.pipelineBehaviors;
        },
        enumerable: false,
        configurable: true
    });
    ...
    Mediator.prototype.registerTypesInResolver = function (resolver) {
        for (var _i = 0, _a = index_js_1.typeMappings.notifications.getAll(); _i < _a.length; _i++) {
            var mapping = _a[_i];
            resolver.add(mapping.handlerClass);
        }
        for (var _b = 0, _c = index_js_1.typeMappings.requestHandlers.getAll(); _b < _c.length; _b++) {
            var mapping = _c[_b];
            resolver.add(mapping.handlerClass);
        }
        for (var _d = 0, _e = index_js_1.typeMappings.pipelineBehaviors.getAll(); _d < _e.length; _d++) {
            var mapping = _e[_d];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        behaviors = index_js_1.typeMappings.pipelineBehaviors.getAll();
    ...
    Mediator.prototype.getRequiredHandlerForRequest = function (request) {
        var handlerClasses = index_js_1.typeMappings.requestHandlers.getAll(request.constructor);
    ...
    Mediator.prototype.publish = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        events = index_js_1.typeMappings.notifications.getAll(message.constructor);
